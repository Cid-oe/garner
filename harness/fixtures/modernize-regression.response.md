...
/**
 * Harness fixture, hand-written: a modernization that falls into every trap (HALF_UP, >= 10, case-sensitive switch, no weekend rollover) used to
...
public class InvoiceCalculator {
    ...
    public String normalizeCustomerType(String raw) {
        ...
        return switch (raw.trim()) {
            case TYPE_WHOLESALE -> TYPE_WHOLESALE;
            case TYPE_STAFF -> TYPE_STAFF;
            default -> TYPE_RETAIL;
        };
    }
    ...
    public BigDecimal lineTotal(String sku, int quantity, String customerType) {
        ...
        return gross.multiply(BigDecimal.ONE.subtract(BigDecimal.valueOf(rate))).setScale(2, RoundingMode.HALF_UP);
    }
